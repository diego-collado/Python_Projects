...
Condiciones a cumplir: 
    ...
    · repetir el menú hasta que se introduzca un 5
...
seguir = True # la utilizamos para poder entrar en el bucle y ejecutar el programa

while seguir: # es lo mismo que decir que seguir = True
