'''
Email Scraper para Websites
Necesario: pip install -r requirements.txt
Para utilizarlo, tenemos que crear un exe con PyInstaller: https://pyinstaller.org/en/stable/
    - websites en inglés: email_scraper.exe EN
    - websites en español: email_scraper.exe ES
'''
